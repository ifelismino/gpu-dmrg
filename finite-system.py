...
def single_dmrg_step(sys, env, m):
    ...
    # Call the GPU Accelerated Jacobi Davidson to find the ground state energy
    (energy,), psi0 = JDh_GPU_SPS(superblock_hamiltonian)
